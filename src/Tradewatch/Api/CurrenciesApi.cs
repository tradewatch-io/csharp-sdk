...
namespace Tradewatch.Api
{
    ...
    public interface ICurrenciesApiSync : IApiAccessor
    {
        ...
        Conversion convert(string from, string to, int operationIndex = 0);
        ...
        /// <param name="to"></param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Conversion</returns>
        ApiResponse<Conversion> convertWithHttpInfo(string from, string to, int operationIndex = 0);
        /// <summary>
        /// Last Quote
        /// </summary>
        /// <remarks>
    ...
    public interface ICurrenciesApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<Conversion> convertAsync(string from, string to, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken));
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Conversion)</returns>
        System.Threading.Tasks.Task<ApiResponse<Conversion>> convertWithHttpInfoAsync(string from, string to, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken));
        /// <summary>
        /// Last Quote
        /// </summary>
        /// <remarks>
    ...
    public partial class CurrenciesApi : ICurrenciesApi
    {
        ...
        /// <returns></returns>
        public CurrenciesApi(Tradewatch.Client.Configuration configuration)
        {
        ...
        public CurrenciesApi(Tradewatch.Client.ISynchronousClient client, Tradewatch.Client.IAsynchronousClient asyncClient, Tradewatch.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>Conversion</returns>
        public Conversion convert(string from, string to, int operationIndex = 0)
        {
            Tradewatch.Client.ApiResponse<Conversion> localVarResponse = convertWithHttpInfo(from, to);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Conversion</returns>
        public Tradewatch.Client.ApiResponse<Conversion> convertWithHttpInfo(string from, string to, int operationIndex = 0)
        {
            // verify the required parameter 'from' is set
            if (from == null)
            {
                throw new Tradewatch.Client.ApiException(400, "Missing required parameter 'from' when calling CurrenciesApi->convert");
            }

            // verify the required parameter 'to' is set
            if (to == null)
            {
                throw new Tradewatch.Client.ApiException(400, "Missing required parameter 'to' when calling CurrenciesApi->convert");
            }
            ...
            localVarRequestOptions.Operation = "CurrenciesApi.convert";
            ...
            var localVarResponse = this.Client.Get<Conversion>("/currencies/convert/{from}/{to}", localVarRequestOptions, this.Configuration);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of Conversion</returns>
        public async System.Threading.Tasks.Task<Conversion> convertAsync(string from, string to, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
            Tradewatch.Client.ApiResponse<Conversion> localVarResponse = await convertWithHttpInfoAsync(from, to, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Conversion)</returns>
        public async System.Threading.Tasks.Task<Tradewatch.Client.ApiResponse<Conversion>> convertWithHttpInfoAsync(string from, string to, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
            // verify the required parameter 'from' is set
            if (from == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<Conversion>("/currencies/convert/{from}/{to}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public Tradewatch.Client.ApiResponse<LastQuote> getQuoteWithHttpInfo(string symbol, int? precision = default(int?), int operationIndex = 0)
        {
            ...
            if (symbol == null)
            {
                throw new Tradewatch.Client.ApiException(400, "Missing required parameter 'symbol' when calling CurrenciesApi->getQuote");
            }
            ...
            localVarRequestOptions.Operation = "CurrenciesApi.getQuote";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<LastQuote>("/currencies/symbols/{symbol}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<Tradewatch.Client.ApiResponse<LastQuote>> getQuoteWithHttpInfoAsync(string symbol, int? precision = default(int?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<LastQuote>("/currencies/symbols/{symbol}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public Tradewatch.Client.ApiResponse<CursorPageTCustomizedSymbolsOutFull> getSymbolsWithHttpInfo(SymbolsListMode mode, int? size = default(int?), int? page = default(int?), string? cursor = default(string?), int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Operation = "CurrenciesApi.getSymbols";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<CursorPageTCustomizedSymbolsOutFull>("/currencies/symbols", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<Tradewatch.Client.ApiResponse<CursorPageTCustomizedSymbolsOutFull>> getSymbolsWithHttpInfoAsync(SymbolsListMode mode, int? size = default(int?), int? page = default(int?), string? cursor = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<CursorPageTCustomizedSymbolsOutFull>("/currencies/symbols", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
