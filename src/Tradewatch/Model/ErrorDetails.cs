...
namespace Tradewatch.Model
{
    ...
    public partial class ErrorDetails : IValidatableObject
    {
        ...
        public ErrorDetails(int code = default(int), string message = default(string))
        {
            this.Code = code;
            // to ensure "message" is required (not null)
            if (message == null)
            {
                throw new ArgumentNullException("message is a required property for ErrorDetails and cannot be null");
            }
