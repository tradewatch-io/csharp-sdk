...
namespace Example
{
    public class getQuoteExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new CommoditiesApi(config);
            ...
            {
                Debug.Print("Exception when calling CommoditiesApi.getQuote: " + e.Message);
...
{
    Debug.Print("Exception when calling CommoditiesApi.getQuoteWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
<a id="getsymbols"></a>
# **getSymbols**
> CursorPageTCustomizedSymbolsOutFull getSymbols (SymbolsListMode mode, int? size = null, CommodityType? type = null, int? page = null, string? cursor = null)
...
namespace Example
{
    public class getSymbolsExample
    {
        public static void Main()
        {
            ...
            var type = new CommodityType?(); // CommodityType? |  (optional) 
            ...
            {
                Debug.Print("Exception when calling CommoditiesApi.getSymbols: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
{
    // Available Symbols
    ApiResponse<CursorPageTCustomizedSymbolsOutFull> response = apiInstance.getSymbolsWithHttpInfo(mode, size, type, page, cursor);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling CommoditiesApi.getSymbolsWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
| **type** | [**CommodityType?**](CommodityType?.md) |  | [optional]  |
...
namespace Example
{
    public class getTypesExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling CommoditiesApi.getTypes: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
{
    // Available Types
    ApiResponse<CommodityTypesList> response = apiInstance.getTypesWithHttpInfo();
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling CommoditiesApi.getTypesWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
